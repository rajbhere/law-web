    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6 text-end">
          <!-- Submit button (if part of a form) -->
         
          <!-- Navigation button to client_form.html -->
          <button onclick="window.location.href='client_form.html'" class="btn btn-primary ms-2">Client Enquiry Form</button>
        </div>
      </div>
    </div>
    <!--end::Container-->
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0">Client Enquiry</h3></div>
              <div class="col-sm-4">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead class="table-primary">
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 10%;">Aadhar No</th>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>
                                                ...
                                                <td class='text-center'>" . htmlspecialchars($row['aadhar_no']) . "</td>
                                                <td class='text-center'>
                                                    <a href='#' class='btn btn-sm btn-info edit-btn' data-id='" . $row['client_id'] . "' data-toggle='modal' data-target='#editModal'>Edit</a>
                                                    <a href='Client_Enquiry.php?delete_id=" . $row['client_id'] . "' class='btn btn-sm btn-danger delete-btn' onclick='return confirm(\"Are you sure you want to delete this client?\")'>Delete</a>
                                                </td>
                                            </tr>";
                                    }
                                    ...
                                    echo "<tr><td colspan='7' class='text-center text-danger'>No client records found.</td></tr>";
                                }

                                // Handle delete
                                if (isset($_GET['delete_id']) && is_numeric($_GET['delete_id'])) {
                                    $delete_id = $conn->real_escape_string($_GET['delete_id']);
                                    $delete_sql = "DELETE FROM client WHERE client_id = '$delete_id'";
                                    if ($conn->query($delete_sql) === TRUE) {
                                        echo "<script>alert('Client deleted successfully'); window.location.href='Client_Enquiry.php';</script>";
                                    } else {
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_client_id'])) {
                                    $id = $conn->real_escape_string($_POST['edit_client_id']);
                                    ...
                                    $aadhar_no = $conn->real_escape_string($_POST['edit_aadhar_no']);

                                    $update_sql = "UPDATE client SET name='$name', email='$email', phone='$phone', address='$address', aadhar_no='$aadhar_no' WHERE client_id='$id'";
                                    if ($conn->query($update_sql) === TRUE) {
                                        echo "<script>alert('Client updated successfully'); window.location.href='Client_Enquiry.php';</script>";
                                    } else {
                                        echo "<script>alert('Error updating client: " . $conn->error . "');</script>";
                                    }
                                }
                                ?>
                            </tbody>
